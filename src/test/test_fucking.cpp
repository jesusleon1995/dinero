...
#define BOOST_TEST_MODULE Fucking Test Suite

#include "test_fucking.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_fucking_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));

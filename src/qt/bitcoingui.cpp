    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Fucking Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Fucking address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and fucking: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Fucking Core"), this);
    aboutAction->setStatusTip(tr("Show information about Fucking Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Fucking Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Fucking addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Fucking addresses"));
    ...
    openAction->setStatusTip(tr("Open a fucking: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Fucking Core help message to get a list with possible Fucking Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Fucking Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Fucking network", "", count));
    } else {
...
{
    QString strTitle = tr("Fucking Core"); // default title

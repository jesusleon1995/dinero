...
//! These need to be macros, as clientversion.cpp's and fucking*-res.rc's voodoo requires it
...
/**
 * fuckingd-res.rc includes this file, but it cannot cope with real c++ code.

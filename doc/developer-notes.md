...
Fucking Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as Fucking Core, where everyone uses
...
pay attention to for reviewers of Fucking Core code.

General Fucking Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Fucking Core uses tinyformat, which is type safe. Leave them out to avoid confusion

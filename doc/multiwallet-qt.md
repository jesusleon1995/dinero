...
Only requiring some minor changes is fucking.cpp.
...
Changes to fucking.cpp
----------------------
fucking.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for

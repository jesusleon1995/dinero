...
This mechanism has been integrated into Bitcore-Node-Fucking which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/fuckingcoin/insight-api-fucking#web-socket-api](https://github.com/fuckingcoin/insight-api-fucking#web-socket-api)
* API: [https://github.com/fuckingcoin/insight-api-fucking#instantsend-transactions](https://github.com/fuckingcoin/insight-api-fucking#instantsend-transactions)
...
By default, the Fucking Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Fucking Core daemon:
